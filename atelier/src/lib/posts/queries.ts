...
import { isPostCategory, type Post } from "./types";
...
const POST_SELECT =
  "id, author_id, caption, category, image_path, image_width, image_height, created_at, author:profiles(handle, display_name)";
