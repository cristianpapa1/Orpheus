...
const en: Dictionary = {
  ...
  storeEditor: { storeName: "Store name", handle: "Handle", description: "Description", accent: "Accent", saveStore: "Save store", openStore: "Open store", viewYourStore: "View your store →" },
...
const fr: Dictionary = {
  ...
  storeEditor: { storeName: "Nom de la boutique", handle: "Identifiant", description: "Description", accent: "Accent", saveStore: "Enregistrer la boutique", openStore: "Ouvrir la boutique", viewYourStore: "Voir votre boutique →" },
...
const pt: Dictionary = {
  ...
  storeEditor: { storeName: "Nome da loja", handle: "Identificador", description: "Descrição", accent: "Destaque", saveStore: "Salvar loja", openStore: "Abrir loja", viewYourStore: "Ver sua loja →" },
...
const de: Dictionary = {
  ...
  storeEditor: { storeName: "Shop-Name", handle: "Handle", description: "Beschreibung", accent: "Akzent", saveStore: "Shop speichern", openStore: "Shop eröffnen", viewYourStore: "Ihren Shop ansehen →" },
...
const ja: Dictionary = {
  ...
  storeEditor: { storeName: "ストア名", handle: "ハンドル", description: "説明", accent: "アクセント", saveStore: "ストアを保存", openStore: "ストアを開く", viewYourStore: "あなたのストアを見る →" },
...
const zh: Dictionary = {
  ...
  storeEditor: { storeName: "店铺名称", handle: "标识", description: "描述", accent: "强调色", saveStore: "保存店铺", openStore: "开设店铺", viewYourStore: "查看你的店铺 →" },
...
const ar: Dictionary = {
  ...
  storeEditor: { storeName: "اسم المتجر", handle: "المعرّف", description: "الوصف", accent: "لون التمييز", saveStore: "حفظ المتجر", openStore: "فتح المتجر", viewYourStore: "عرض متجرك →" },
...
const ru: Dictionary = {
  ...
  storeEditor: { storeName: "Название магазина", handle: "Адрес", description: "Описание", accent: "Акцент", saveStore: "Сохранить магазин", openStore: "Открыть магазин", viewYourStore: "Открыть ваш магазин →" },
...
const it: Dictionary = {
  ...
  storeEditor: { storeName: "Nome del negozio", handle: "Handle", description: "Descrizione", accent: "Accento", saveStore: "Salva negozio", openStore: "Apri negozio", viewYourStore: "Vedi il tuo negozio →" },
